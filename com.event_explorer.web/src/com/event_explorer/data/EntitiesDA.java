...
public class EntitiesDA extends BaseDA<Entity> {
	...
	{
		List<Entity> entities = BaseQuery(idEntity, "Hierarchy", NavigationDirection.INBOUND);
	...
	{
		List<Entity> entities = BaseQuery(idEntity, "Hierarchy", NavigationDirection.OUTBOUND);
		if(entities != null && !entities.isEmpty())
			return entities.get(0);
	...
	{
		return BaseQuery(idEvent, "Who", NavigationDirection.OUTBOUND);
	}
